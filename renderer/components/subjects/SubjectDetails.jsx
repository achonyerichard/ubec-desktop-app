    ...
    <main className="pt-16 lg:pt-24 relative">
      <div className="mx-auto max-w-[1000px] px-6 lg:px-0">
        ...
        >
          <div className="flex items-center justify-center min-height-100vh pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div
              className="inline-block align-center  bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle w-[80%] mx-auto "
              role="dialog"
              aria-modal="true"
              aria-labelledby="modal-headline"
            >
      ...
      <div className="h-screen relative bg-blue-200 bg-opacity-25 mt-10 flex flex-col justify-center items-center">
        ...
        <div className="flex flex-col justify-center items-center cursor-pointer">
          ...
          <Image
            className="w-auto h-auto rounded-[40px] object-cover pt-5"
